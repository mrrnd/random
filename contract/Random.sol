...
contract Random {
    ...
    uint public liveBlocksNumber = 5; // amount of blocks untill the lottery ending
    ...
    function Random(uint _liveBlocksNumber) public {
        manager = msg.sender;
        if(_liveBlocksNumber > 0) {
             liveBlocksNumber = _liveBlocksNumber;
        }
        // onePotWei = _ticketPrice;
